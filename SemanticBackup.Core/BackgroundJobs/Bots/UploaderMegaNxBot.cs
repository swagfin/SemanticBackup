...
namespace SemanticBackup.Core.BackgroundJobs.Bots
{
    internal class UploaderMegaNxBot : IBot
    {
        ...
        private readonly ILogger<UploaderMegaNxBot> _logger;
        ...
        public UploaderMegaNxBot(BackupRecord backupRecord, ContentDeliveryRecord contentDeliveryRecord, ContentDeliveryConfiguration contentDeliveryConfiguration, IServiceScopeFactory scopeFactory)
        {
            ...
            using (var scope = _scopeFactory.CreateScope())
                _logger = scope.ServiceProvider.GetRequiredService<ILogger<UploaderMegaNxBot>>();
        }
