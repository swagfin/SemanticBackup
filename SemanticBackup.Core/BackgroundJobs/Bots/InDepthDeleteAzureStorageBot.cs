...
namespace SemanticBackup.Core.BackgroundJobs.Bots
{
    internal class InDepthDeleteAzureStorageBot : IBot
    {
        ...
        public InDepthDeleteAzureStorageBot(string resourceGroupId, BackupRecord backupRecord, BackupRecordDelivery contentDeliveryRecord, ContentDeliveryConfiguration contentDeliveryConfiguration, IServiceScopeFactory scopeFactory)
        {
