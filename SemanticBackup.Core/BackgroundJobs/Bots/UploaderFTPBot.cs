...
namespace SemanticBackup.Core.BackgroundJobs.Bots
{
    internal class UploaderFTPBot : IBot
    {
        ...
        public UploaderFTPBot(BackupRecord backupRecord, ContentDeliveryRecord contentDeliveryRecord, ContentDeliveryConfiguration contentDeliveryConfiguration, IServiceScopeFactory scopeFactory)
        {
