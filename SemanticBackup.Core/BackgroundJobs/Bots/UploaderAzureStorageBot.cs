...
namespace SemanticBackup.Core.BackgroundJobs.Bots
{
    internal class UploaderAzureStorageBot : IBot
    {
        ...
        public UploaderAzureStorageBot(string resourceGroupId, BackupRecord backupRecord, BackupRecordDelivery contentDeliveryRecord, ContentDeliveryConfiguration contentDeliveryConfiguration, IServiceScopeFactory scopeFactory)
        {
