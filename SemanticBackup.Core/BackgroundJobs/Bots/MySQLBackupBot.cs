...
namespace SemanticBackup.Core.BackgroundJobs.Bots
{
    internal class MySQLBackupBot : IBot
    {
        ...
        public MySQLBackupBot(BackupDatabaseInfo databaseInfo, BackupRecord backupRecord, IMySQLServerBackupProviderService backupProviderService, IBackupRecordPersistanceService persistanceService, SharedTimeZone sharedTimeZone, ILogger logger)
        {
